...
public class StripeQuote {
    ...
    public Quote createQuote(DatabaseQuote databaseQuote) {
        try {
    ...
    public Quote updateQuote(String quoteId, DatabaseQuote databaseQuote) {
        try {
            Map<String, Object> params = new HashMap<>();
            List<Object> items = databaseQuote.getItems();
    ...
    public Quote finalizeQuote(String quoteId) {
        try {
            Quote quote = Quote.retrieve(quoteId);
    ...
    public Quote cancelQuote(String quoteId) {
        try {
            Quote quote = Quote.retrieve(quoteId);
