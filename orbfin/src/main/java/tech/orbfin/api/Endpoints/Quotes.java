...
public class Quotes {
    ...
    @PostMapping
    public void createQuote(@RequestBody DatabaseQuote quote) {
    ...
    @GetMapping
    public QuoteCollection getAllQuotes() {
    ...
    public void finalizeQuote(@PathVariable String quoteId) {
        stripeQuote.finalizeQuote(quoteId);
    }

    @PostMapping("/{quoteId}/accept")
    public void acceptQuote(@PathVariable String quoteId) {
        stripeQuote.acceptQuote(quoteId);
    }

    @PostMapping("/{quoteId}/cancel")
    public void cancelQuote(@PathVariable String quoteId) {
